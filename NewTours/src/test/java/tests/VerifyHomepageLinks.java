...
public class VerifyHomepageLinks {
	...
	public void Setup() throws IOException {
		...
		testData = objExcel.readExcel(".\\TestData", "TestDataFile.xlsx", "DashBoard");
...
//		Runtime.getRuntime().exec("taskkill /F /IM chromedriver.exe /T");
		...
		report = extent.createTest("New Tours - Verify Dashboard", "VerifyDashboard");
	...
	public void VerifyDashBoard() throws Exception {
		appFunc.DashboardMenu(driver, testData, report);
	}
	...
	public void teardown() throws Exception {
		...
		driver.close();
		driver.quit();
		System.out.println("********************END of 'DashBoardVerification'*************************");
	}
