...
public class RegisterNewTours {
	...
	public void Setup() throws IOException {
		...
		testData = objExcel.readExcel(".\\TestData", "TestDataFile.xlsx", "Register");
		...
		report = extent.createTest("New Tours - Register", "Register New Tours");
...
//		appFunc.Login_NewTours(driver,report);
		appFunc.EnrollRegistration(driver, testData,report);
	}
	...
	public void teardown() throws Exception {
		...
		driver.close();
		driver.quit();
		System.out.println("********************END of 'Register New Tours'*************************");
	}
