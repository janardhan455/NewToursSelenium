...
//	public static String filePath = "D:\\ExtentReports\\extentreport.html";
	...
	private static ExtentHtmlReporter getHtmlReporter(String FilePath, String DocumentTitle, String ReportName) {
		...
		// htmlReporter.loadXMLConfig("C:\\Users\\hemar\\Jenkins_Workspace\\Project
		// Workspace\\git\\SelTestNG_DD\\Config Files\\Extent-Config.xml");
		return htmlReporter;
	}
