...
public class ExcelUtilities {
	...
	public static void main(String... strings) throws IOException {
		...
		final String[][] item = objExcelFile.readExcel("C:\\Users\\hemar\\workspace\\SelTestNG_DD\\TestData",
				"TestDataFile.xlsx", "TestData_Sheet");
		for (int i = 0; i < item[0].length; i++) {
			System.out.println("item[" + 0 + "][i]: " + item[0][i]);
		}

		// ExcelUtilities objExcelFile2 = new ExcelUtilities();
		// objExcelFile2.updateExcel(System.getProperty("user.dir")+"\\src\\TestDataFiles","PPS_TestDataFile.xlsx","TestData_Sheet",
		// "Added to Cart", 3, 7);
	...
	public void writeExcelRow(String filePath, String fileName, String sheetName, String[] dataToWrite)
			throws IOException {
	...
	public void updateExcel(String filePath, String fileName, String sheetName, String dataToWrite, int rowNumber,
